<x-layout>
    ...
    <x-panel>
        <!-- btn create -->
        <div class="flex">
            <Link href="/posts/create" class="px-4 py-2 bg-gray-100 rounded-md text-sm border flex items-center gap-2 text-gray-700">
        ...
        <x-splade-table :for="$posts">
            <x-slot:empty-state>
                ...
                <div class="flex gap-2">
                    <Link href="{{ route('posts.edit', $posts->id) }}" class="rounded-full p-2 bg-orange-300 text-white hover:bg-orange-400">
